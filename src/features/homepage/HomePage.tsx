...
const HomePage = () => {
  const features = [
    ...
    },
    {
      ...
      description: "24/7 access to certified pharmacists for professional medical advice",
    ...
    },
    {
      ...
      title: "Secure & Safe",
      description: "Bank-level security with verified medicines from licensed suppliers",
  ...
  const steps = [
    {
      number: "01",
      title: "Search & Browse",
      description: "Find medicines from our extensive catalog or search by name",
    },
    {
      number: "02",
    ...
    },
    {
      ...
      description: "Choose from multiple payment options and confirm your order",
    },
    {
      number: "04",
      title: "Fast Delivery",
      description: "Receive your medicines at your doorstep with tracking updates",
    },
  ]
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose MediNow?</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Experience the future of pharmacy services with our comprehensive healthcare solutions
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">Get your medicines delivered in 4 simple steps</p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join thousands of satisfied customers who trust MediNow for their pharmaceutical needs
              </p>
